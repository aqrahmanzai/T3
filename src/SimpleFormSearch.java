...
public class SimpleFormSearch extends HttpServlet {
   ...
   void search(String keyword, HttpServletResponse response) throws IOException {
      ...
      try {
         ...
         if (keyword.isEmpty()) {
            String selectSQL = "SELECT * FROM MyTableRahmanzai";
            preparedStatement = connection.prepareStatement(selectSQL);
         } else {
            String selectSQL = "SELECT * FROM MyTableRahmanzai WHERE EMAIL LIKE ?";
         ...
         while (rs.next()) {
            ...
            String theemail = rs.getString("email").trim();
            String phone = rs.getString("phone").trim();

            if (keyword.isEmpty() || theemail.contains(keyword)) {
               out.println("ID: " + id + ", ");
               out.println("User: " + userName + ", ");
               out.println("Email: " + theemail + ", ");
